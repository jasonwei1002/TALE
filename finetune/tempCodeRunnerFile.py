...
def main():
    ...
    data_split_path = dataset_root / 'preprocessed-1d'
    
    if 'ptbxl-super' in args.dataset:
        # set the path where you store the ptbxl dataset
        data_split_path = os.path.join(data_split_path, 'ptbxl-super')
        
        train_csv_path = f'{data_split_path}/train.csv'
        val_csv_path = f'{data_split_path}/val.csv'
        test_csv_path = f'{data_split_path}/test.csv'
        
        train_dataset = ECGDataset(train_csv_path, mode='train', dataset_name='ptbxl-super', ratio=args.ratio,
                                   )
        val_dataset = ECGDataset(val_csv_path, mode='val', dataset_name='ptbxl-super',
                                   )
        test_dataset = ECGDataset(test_csv_path, mode='test', dataset_name='ptbxl-super',
                                   )

        args.labels_name = train_dataset.labels_name
        num_classes = train_dataset.num_classes
    elif 'ptbxl-sub' in args.dataset:
        data_split_path = os.path.join(data_split_path, 'ptbxl-sub')
        
        train_csv_path = f'{data_split_path}/train.csv'
        val_csv_path = f'{data_split_path}/val.csv'
        test_csv_path = f'{data_split_path}/test.csv'
        
        train_dataset = ECGDataset(train_csv_path, mode='train', dataset_name='ptbxl-sub', ratio=args.ratio,
                                   )
        val_dataset = ECGDataset(val_csv_path, mode='val', dataset_name='ptbxl-sub',
                                   )
        test_dataset = ECGDataset(test_csv_path, mode='test', dataset_name='ptbxl-sub',
                                   )
        ...
        data_split_path = os.path.join(data_split_path, 'ptbxl-form')
        
        train_csv_path = f'{data_split_path}/train.csv'
        val_csv_path = f'{data_split_path}/val.csv'
        test_csv_path = f'{data_split_path}/test.csv'
        
        train_dataset = ECGDataset(train_csv_path, mode='train', dataset_name='ptbxl-form', ratio=args.ratio,
                                   )
        val_dataset = ECGDataset(val_csv_path, mode='val', dataset_name='ptbxl-form',
                                   )
        test_dataset = ECGDataset(test_csv_path, mode='test', dataset_name='ptbxl-form',
                                   )
        ...
        data_split_path = os.path.join(data_split_path, 'ptbxl-rhythm')
        
        train_csv_path = f'{data_split_path}/train.csv'
        val_csv_path = f'{data_split_path}/val.csv'
        test_csv_path = f'{data_split_path}/test.csv'
        
        train_dataset = ECGDataset(train_csv_path, mode='train', dataset_name='ptbxl-rhythm', ratio=args.ratio,
                                   )
        val_dataset = ECGDataset(val_csv_path, mode='val', dataset_name='ptbxl-rhythm',
                                   )
        test_dataset = ECGDataset(test_csv_path, mode='test', dataset_name='ptbxl-rhythm',
                                   )
        ...
        train_dataset = ECGDataset(train_csv_path, mode='train', dataset_name='icbeb', ratio=args.ratio,
                                   )
        val_dataset = ECGDataset(val_csv_path, mode='val', dataset_name='icbeb',
                                   )
        test_dataset = ECGDataset(test_csv_path, mode='test', dataset_name='icbeb',
                                   )
        ...
        data_split_path = os.path.join(data_split_path, 'chapman')
        
        train_csv_path = f'{data_split_path}/train.csv'
        val_csv_path = f'{data_split_path}/val.csv'
        test_csv_path = f'{data_split_path}/test.csv'
        
        train_dataset = ECGDataset(train_csv_path, mode='train', dataset_name='chapman', ratio=args.ratio,
                                   )
        val_dataset = ECGDataset(val_csv_path, mode='val', dataset_name='chapman',
                                   )
        test_dataset = ECGDataset(test_csv_path, mode='test', dataset_name='chapman',
                                   )
